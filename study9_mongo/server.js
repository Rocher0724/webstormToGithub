...
// 11. 특정 아이디값 가져오기
Student.findOne({ _id: '58ec49959b245212c0e51b7f' }, function (error, student) {
...
//// 12. 특정아이디 수정하기
//Student.findById({ _id: '58ec49959b245212c0e51b7f' }, function (error, student) {
//    console.log('--- Update(PUT) ---');
//    if (error) {
//        console.log(error);
//    } else {
//        student.name = 'choongyul';
...
// 13. 삭제
Student.remove({ _id: '58ec4ac157dd322d609cd03f' }, function (error, output) {
    console.log('--- Delete ---');
    if (error) {
        console.log(error);
    }
